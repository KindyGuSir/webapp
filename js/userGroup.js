...
function postAjax(id,page){
    ...
    $.ajax({
        type:'post',
        url:rootpath + "/group/Group_getUserByGroupId.do",
            ...
            success:function(data){
                ...
                layer.prompt({title: '重命名', formType: 0,value:name}, function(text, index){
                    ...
                    $.ajax({
                        ...
                        data:{'group.id':id,'group.type':'user','group.name':name},
                        async: false,
                        success:function(data){
                        }
                    });
	...
	$(".anug").bind("click",function(){
        ...
        layer.prompt({title: '新建组', formType: 0}, function(text, index){
            ...
            $.ajax({
                ...
                data:{'group.name':name,'group.type':'user','group.parentId':id},
                success:function(data){
                    location.href="/group/Group_groupList.do?type=user";

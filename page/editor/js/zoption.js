...
CAMPUS.Options = {
    el : {
        leftMenuBox :  CAMPUS.util.byId('left_menu_box'),
        leftPageBox :  CAMPUS.util.byId('left_page_box'),
        mainBox : CAMPUS.util.byId('main_box'),
        mainBoxIn : CAMPUS.util.byId('main_box_inner'),
        pageBoxIn : CAMPUS.util.byId('left_page_inner'),
        pgDragHint : CAMPUS.util.byId('page_drag_hint'),
        prptBar : CAMPUS.util.byId('property_bar'),
        editElMask : CAMPUS.util.isIE()?IWIN.util.byId('editEle_mask_2'):IWIN.util.byId('editEle_mask_1'),
        ctrEleMask : CAMPUS.util.byId('ctrlEle_mask'),
        delElsDiv : CAMPUS.util.byId('deleted_els'),
        cutElsDiv : CAMPUS.util.byId('cut_els'),
        delPgsDiv : CAMPUS.util.byId('deleted_pgs'),
        baslineH : CAMPUS.util.byId('baseline_horizontal_1'),
        baslineH_2 : CAMPUS.util.byId('baseline_horizontal_2'),
        baslineV : CAMPUS.util.byId('baseLine_vertical_1'),
        baslineV_2 : CAMPUS.util.byId('baseLine_vertical_2'),
        layerBox : CAMPUS.util.byId('mylayer'),
        layerTable : CAMPUS.util.byId('layertable'),
        compGrpList : CAMPUS.util.byId('comp_group_list'),
        compPnlList : CAMPUS.util.byId('comp_panel_list'),
        layerLocktable : CAMPUS.util.byId('layerLocktable'), // 在普通编辑页面  如果部件处于锁定状态 则右键只允许进行 锁定 解锁两个操作    update 20150130
        layerQtable : CAMPUS.util.byId('layerQtable'),  // 快速编辑页面 右键菜单（置顶 置底 上移一层 下移一层）   update 20150205
        mainb : CAMPUS.util.byId('mainb'),
    ...
    cur : {
        program : CAMPUS.util.getQueryString('prid'),
        page : '1',
        w : 720,
        h :540
    },

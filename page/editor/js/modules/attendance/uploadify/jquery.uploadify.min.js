...
(function (c) {
            ...
            return this.each(function () {
                ...
                if (h) {
                    ...
                    var l = c("<div />", {
                        id: j.id,
                        "class": "uploadify",
                        css: {height: j.height + "px", width: j.width + "px"}
                    });
                    ...
                    if (j.buttonImage) {
                        f.css({"background-image": "url('" + j.buttonImage + "')", "text-indent": "-9999px"});
                    }
                    ...
                    i.queueData = {
                        ...
                        uploadQueue: [],
                        errorMsg: "您所上传的文件类型不支持。" /*"Some files were not added to the queue:"*/
                    };
                    i.original = m;
                    i.wrapper = l;
                    i.button = f;
    ...
    var a = {
        onDialogOpen: function () {
            var d = this.settings;
            this.queueData.errorMsg = "您所上传的文件类型不支持。" /*"Some files were not added to the queue:"*/;
            ...
            if (i.itemTemplate == false) {
                i.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">					<div class="cancel">						<a href="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')">X</a>					</div>					<span class="fileName">${fileName} (${fileSize})</span><span class="data">待上传</span>					<div class="uploadify-progress">						<div class="uploadify-progress-bar"><!--Progress Bar--></div>					</div>				</div>';
            }
            ...
            if (c.inArray("onUploadProgress", h.overrideEvents) < 0) {
                if (h.progressData == "percentage") {
                    ...
                    c("#" + g.id).find(".data").html("&nbsp;&nbsp;&nbsp;&nbsp;<font color='red'>上传中...</font>")
                } else {
            ...
            if (e.checkExisting) {
                c.ajax({
                    type: "POST", async: false, url: e.checkExisting, data: {filename: d.name}, success: function (h) {
                        if (h == 1) {

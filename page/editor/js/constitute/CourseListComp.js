...
IWIN.util.extend(CourseListComp,CompChClass);

IWIN.util.extend(CourseListComp,{
    ...
    setProperty : function (item,name,value){
        ...
        switch (name){
            case 'cListID':
				...
				//var data = IWIN.util.getCurrentCList(value);
                //params.cData = data;
                break;
			 case 'cData':
                params.cData = value; 
...
IWIN.Options.comp_map['22'] = CourseListComp;

...
IWIN.util.extend(TimeComp_1,CompScClass);

IWIN.util.extend(TimeComp_1,{
    ...
    getProperty : function (item,name){
        ...
        switch (name){
			...
			case 'font_color':
               ...
               return IWIN.util.getClrRgb(clr);
			case 'bd_width':
				//return IWIN.util.getStyleVal(timeObj,'borderLeftWidth');
				return params.bdW;
			case 'bd_color':
			   var clr = params.bdC;
               return IWIN.util.getClrRgb(clr);
...
IWIN.Options.comp_map['16'] = TimeComp_1;

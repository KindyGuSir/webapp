...
var  ClassdynamicsComp = {
    srcClass: 'CLASSDYNAMICS_COMP_img'
};
IWIN.util.extend(ClassdynamicsComp,CompChClass);
IWIN.util.extend(ClassdynamicsComp,{
...
IWIN.Options.comp_map['27'] = ClassdynamicsComp;
...
IWIN.util.extend(VerticalLineComp,CompChClass);
IWIN.util.extend(VerticalLineComp,{
    ...
    getProperty : function (item,name){
        ...
        switch (name){
            ...
            case 'bd_style':
                return IWIN.util.getStyle(rect,'borderLeftStyle');
            case 'bd_opacity':
                var clr = params.bdC;
...
IWIN.Options.comp_map['7'] = VerticalLineComp;

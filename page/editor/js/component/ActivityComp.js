 ...
 * */
var  ActivityComp = {
    dftVals : {classId:"",tName:encodeURI(encodeURI("班级活动")),imageList:[],effect:"0"},
    srcClass: 'Activity_COMP_src'
};
IWIN.util.extend(ActivityComp,CompChClass);
IWIN.util.extend(ActivityComp,{
...
IWIN.Options.comp_map['32'] = ActivityComp;
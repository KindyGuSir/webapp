 ...
 * */
var  UdefinedComp = {
    dftVals : {classId:"",tName:"自定义组件",imageList:[],effect:"0"},
    srcClass: 'Udefined_COMP_src'
};
IWIN.util.extend(UdefinedComp,CompChClass);
IWIN.util.extend(UdefinedComp,{
...
IWIN.Options.comp_map['34'] = UdefinedComp;
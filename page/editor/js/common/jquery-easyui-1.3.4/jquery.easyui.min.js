...
var t=$(_70);
if(_71.text == '取消'){
	t.addClass("l-btn left");
}else if(_71.text == '确定'){
	t.addClass("l-btn right");
}
...
_235.mask.css({width:(_235.options.inline?'100%':'100%'),height:(_235.options.inline?'100%':'100%'),display:"none"});
}
if(_235.shadow){
_235.shadow.remove();
}
...
var name=$.fn.prop?_3da.prop("name"):_3da.attr("name");
opts.value=$(this).val();
opts.searcher.call(_3d8,opts.value,name);//alert(opts.value+".....13");
return false;
}
});
_3db.unbind(".searchbox").bind("click.searchbox",function(){
var name=$.fn.prop?_3da.prop("name"):_3da.attr("name");//alert(opts.value+"---");
opts.searcher.call(_3d8,opts.value,name);
...
/*_4c3.children("div.datagrid-header,div.datagrid-body,div.datagrid-footer").width('809px');
_4c4.children("div.datagrid-header,div.datagrid-body,div.datagrid-footer").width('809px');*/
var hh;
_4c5.css("height","");
_4c6.css("height","");
_4c7.css("height","");
...
var td=$("");
/*var td=$("<td rowspan=\""+opts.frozenColumns.length+"\"><div class=\"datagrid-header-rownumber\"></div></td>"); 表格的全选的复选框*/
if($("tr",t).length==0){
...
cc.push("");
/*cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_66f+"</div></td>"); 列表中每条记录前面的复选框*/
}

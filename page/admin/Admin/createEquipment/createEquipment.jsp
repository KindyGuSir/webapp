...
<div class="pageCont">
	...
	<form class="tables" >
		<p>
			<span>设备名称:</span>
			<input id="name" name ="deviceEntity.name" type="text" placeholder="请填写设备名称">
			<span></span>
		</p>
		<p>
			<span>设备IP:</span>
			<input id="ip" name = "deviceEntity.ipAddress" type="text" placeholder="请填写设备IP">
			<span></span>
		</p>
		<p>
			<span>设备MAC:</span>
			<input id = "mac"name = "deviceEntity.macAddress" type="text" placeholder="请填写设备MAC地址">
			<span></span>
		</p>
...
<script>
	$(".save_submit").click(function () {
		...
		$.ajax({
			type:'post',
			traditional :true,
			url:rootpath + "/device/Device_saveDevice.do",

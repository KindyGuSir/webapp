...
<div class="pageCont">
    ...
    <div class="right-con">
        ...
        <div class="user-tit">
            <img src="${pageContext.request.contextPath}/imgs/nowpath.png" alt="">当前位置：身份管理/添加新身份
        </div>
        <form class="tables">
            <p>
                <span>身份名称: </span>
            ...
            <div class="describe clearfix">
                <p>职责描述:</p>
                <textarea id="roleMark" name="role.mark" value="<s:property value="role.mark"/>"></textarea>
            </div>
